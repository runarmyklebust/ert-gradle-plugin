...
public class ResourceTestUtils
{
    ...
    public static FileObject createFileSystem( String path )
        throws Exception
    {
    ...
    public static int createTree( FileObject root, int maxDepth, int numberOfFiles, int numberOfFolders )
        throws Exception
    {
    ...
    public static int createFoldersWithFiles( FileObject root, int maxDepth, int parentDepth, int folderNum, int numberOfFolders,
                                              int numberOfFiles )
        throws Exception
    {
        ...
        if ( thisDepth <= ( maxDepth - 1 ) )
        {
            ...
            {
                numberOfCreatedObjects =
                    numberOfCreatedObjects + createFoldersWithFiles( folder, maxDepth, thisDepth, i, numberOfFolders, numberOfFiles );
            }
        }
    ...
    public static FileObject createFile( FileObject root, String fileName )
        throws Exception
    {
    ...
    public static void createFile( FileObject root, String parentPostFix, int fileNum )
        throws Exception
    {
    ...
    public static FileObject createFolder( FileObject parent, String folderName )
        throws Exception
    {
