...
import com.enonic.labs.dav.utils.ResourceHashCreator;
...
public class ResourceTreeBuilder
{
    ...
    public ResourceTree getResourceTree() throws Exception
    {
    ...
    private void addNodes(ResourceTree resourceTree, FileObject parent, ResourceFileSelectorInfo parentFileInfo) throws Exception
    {
